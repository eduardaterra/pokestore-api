...
typesRouter.get("/:type", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var offset, limit, currentType, findParams, url, order, _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                offset = isNaN(Number(req.query.offset))
                    ? 0
...
typesRouter.get("/:type/pokemon/:nameOrKey", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var offset, limit, currentType, currentNameOrKey, findSecondParams, findParams, url, order, _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                offset = isNaN(Number(req.query.offset))
                ...
                limit = isNaN(Number(req.query.limit))
                    ...
                    : Number(req.query.limit);
                currentType = req.params.type;
                currentNameOrKey = req.params.nameOrKey === undefined ? null : req.params.nameOrKey;
                findSecondParams = currentNameOrKey !== null
